...
게임·DLC·Workshop·세이브·Steam 계정 데이터는 APK와 이 저장소 어디에도 들어 있지
않습니다. Red Hook Studios 및 Valve와 무관합니다.
...
미배포입니다. Red Hook의 EULA가 파생 저작물을 유보하고 있고 공식 iPad판도 있어서,
서면 요청에 답을 받기 전까지 비공개로 둡니다. 빌드와 테스트는 자유롭게 하되 배포하지
마시고, 포팅이라고 부르지 마십시오 — Winlator 런타임 위의 런처입니다.
