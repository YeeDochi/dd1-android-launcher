...
import io.github.dd1android.launcher.xconnector.ConnectedClient;
import io.github.dd1android.launcher.xconnector.RequestHandler;
...
import io.github.dd1android.launcher.xserver.extensions.Extension;
import io.github.dd1android.launcher.xserver.requests.AtomRequests;
import io.github.dd1android.launcher.xserver.requests.CursorRequests;
import io.github.dd1android.launcher.xserver.requests.DrawRequests;
import io.github.dd1android.launcher.xserver.requests.ExtensionRequests;
import io.github.dd1android.launcher.xserver.requests.FontRequests;
import io.github.dd1android.launcher.xserver.requests.GrabRequests;
import io.github.dd1android.launcher.xserver.requests.GraphicsContextRequests;
import io.github.dd1android.launcher.xserver.requests.KeyboardRequests;
import io.github.dd1android.launcher.xserver.requests.PixmapRequests;
import io.github.dd1android.launcher.xserver.requests.SelectionRequests;
import io.github.dd1android.launcher.xserver.requests.WindowRequests;
...
public class XClientRequestHandler implements RequestHandler {
    ...
    private boolean handleNormalRequest(XClient client, XInputStream inputStream, XOutputStream outputStream) throws IOException {
        ...
        if (TRACE) android.util.Log.i("DD1/XServer", "req seq=" + client.getSequenceNumber()
            ...
            if (opcode < 0) {
                ...
                switch (opcode) {
                    ...
                    case 31:   // GrabKeyboard — pretend success (SDL grabs on fullscreen)
                        client.skipRequest();
                        try (io.github.dd1android.launcher.xconnector.XStreamLock lock = outputStream.lock()) {
                    ...
                    default:
                        ...
                        android.util.Log.w("DD1/XServer", "Unsupported X opcode " + opcode
                                + " (seq " + client.getSequenceNumber() + ") — replying BadImplementation");
                        client.skipRequest();
                        new io.github.dd1android.launcher.xserver.errors.XRequestError(17, 0).sendError(client, opcode);
                        break;
                }
            }
        }
