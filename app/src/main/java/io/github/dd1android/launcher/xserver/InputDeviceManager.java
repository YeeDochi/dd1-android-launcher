...
import io.github.dd1android.launcher.xserver.events.ButtonPress;
import io.github.dd1android.launcher.xserver.events.ButtonRelease;
import io.github.dd1android.launcher.xserver.events.EnterNotify;
import io.github.dd1android.launcher.xserver.events.Event;
import io.github.dd1android.launcher.xserver.events.KeyPress;
import io.github.dd1android.launcher.xserver.events.KeyRelease;
import io.github.dd1android.launcher.xserver.events.LeaveNotify;
import io.github.dd1android.launcher.xserver.events.MappingNotify;
import io.github.dd1android.launcher.xserver.events.MotionNotify;
import io.github.dd1android.launcher.xserver.events.PointerWindowEvent;
    ...
    public void onPointerButtonPress(Pointer.Button button) {
        ...
        if (!xServer.isRelativeMouseMovement()) {
            ...
            if (grabWindow != null && grabWindow.attributes.isEnabled()) {
                ...
                if (button.code() >= 4) {
                    android.util.Log.i("DD1/XServer",
