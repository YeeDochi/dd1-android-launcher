...
import io.github.dd1android.launcher.xserver.render.FullscreenTransformation;
...
import io.github.dd1android.launcher.xserver.Property;
import io.github.dd1android.launcher.xserver.Visual;
import io.github.dd1android.launcher.xserver.Window;
import io.github.dd1android.launcher.xserver.WindowAttributes;
import io.github.dd1android.launcher.xserver.WindowManager;
import io.github.dd1android.launcher.xserver.XClient;
import io.github.dd1android.launcher.xserver.errors.BadAccess;
...
import io.github.dd1android.launcher.xserver.errors.BadWindow;
import io.github.dd1android.launcher.xserver.errors.XRequestError;
import io.github.dd1android.launcher.xserver.events.CreateNotify;
import io.github.dd1android.launcher.xserver.events.Event;
import io.github.dd1android.launcher.xserver.events.RawEvent;
...
public abstract class WindowRequests {
    ...
    public static void getProperty(XClient client, XInputStream inputStream, XOutputStream outputStream) throws IOException, XRequestError {
        ...
        if ("WM_STATE".equals(atomName)) {
            Log.i("DD1/XServer", "GetProperty WM_STATE win=0x" + Integer.toHexString(window.id)
    ...
    public static void warpPointer(XClient client, XInputStream inputStream, XOutputStream outputStream) throws IOException, XRequestError {
        ...
        if (dstWindow == null) {
            client.xServer.pointer.setPosition(
                    client.xServer.pointer.getX() + dstX,
                    client.xServer.pointer.getY() + dstY);
        }
        else {
    ...
    public static void setInputFocus(XClient client, XInputStream inputStream, XOutputStream outputStream) throws XRequestError {
        ...
        } else if (windowId == 1) {   // PointerRoot
    ...
    public static void getGeometry(XClient client, XInputStream inputStream, XOutputStream outputStream) throws IOException, XRequestError {
        ...
        android.util.Log.i("DD1/XServer", "GetGeometry win=0x" + Integer.toHexString(drawableId)
